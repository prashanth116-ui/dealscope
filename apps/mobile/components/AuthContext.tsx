...
// Cognito config — replace with actual values after CDK deploy
const USER_POOL_ID = process.env.EXPO_PUBLIC_USER_POOL_ID ?? "us-east-1_XXXXXXXXX";
const CLIENT_ID = process.env.EXPO_PUBLIC_USER_POOL_CLIENT_ID ?? "XXXXXXXXXXXXXXXXXXXXXXXXXX";
